...
RENDER_URL = "https://lc-import-1.onrender.com/generate-lc-draft-import-pdf/"
...
def generate_dummy_data():
    return LCDraftData(
        ...
        drafts_at="Sight",
        drawee=fake.company(),
        partial_shipments=fake.random_element(("Allowed", "Not Allowed")),
        transshipment=fake.random_element(("Allowed", "Not Allowed")),
        ...
        confirmation=fake.random_element(("Without", "May Add", "Add")),
        ...
        goods_incoterm=fake.random_element(("FOB", "CIF", "EXW", "DDP"))
    )
...
print("🎉 All 50 LC Draft PDFs generated!")
